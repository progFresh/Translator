...
//  Twim
//
//  Created by Ivan Smetanin on 20/01/2018.
...
///
/// ```
///protocol CustomModuleTransitionable: class {}
///
...
protocol ModuleTransitionable: class {
    ...
    /// Use this method to update or replace last view controller.
    ///
    /// - Parameters:
    ///   - module: Module that should be presented.
    ///   - animated: Pass true to animate the transition.
    func replaceLast(module: UIViewController, animated: Bool)
    ...
    ///
    func popToViewController(vcClass: UIViewController.Type)
}
